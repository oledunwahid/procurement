...
$query = "SELECT ppr.*, prd.id, prd.nama_barang, prd.qty, prd.uom, prd.unit_price, prd.detail_specification, prd.detail_notes, prd.category, pc.nama_category
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <td data-label='Nama Barang:'><input type='text' name='nama_barang[]' class='form-control' value='" . $row['nama_barang'] . "' readonly /></td>
    <td data-label='Detail Spec:'><textarea name='detail_specification[]' class='form-control' readonly>" . $row['detail_specification'] . "</textarea></td>
    ...
    <td data-label='Harga:'><input type='text' name='unit_price[]' class='form-control' value='" . nominal($row['unit_price']) . "' readonly maxlength='11' /></td>
