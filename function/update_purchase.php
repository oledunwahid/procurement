...
if (isset($_POST['id_proc_ch'])) {
    ...
    $sql = "UPDATE proc_purchase_requests SET title = '$title', nik_request = '$nik_request', category = '$category',  total_price = '$total_price', job_location = '$jobLocation', status = '$status' WHERE id_proc_ch = '$id_proc_ch'";
